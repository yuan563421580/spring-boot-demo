package com.yuansb.demo.zookeeper.aspectj;

import cn.hutool.core.util.ArrayUtil;
import cn.hutool.core.util.ObjectUtil;
import cn.hutool.core.util.StrUtil;
import com.yuansb.demo.zookeeper.annotation.LockKeyParam;
import com.yuansb.demo.zookeeper.annotation.ZooLock;
...
public class ZooLockAspect {
     ...
     * 切入点
     */
    @Pointcut("@annotation(com.yuansb.demo.zookeeper.annotation.ZooLock)")
    public void doLock() {
    ...
    public Object around(ProceedingJoinPoint point) throws Throwable {
        ...
        String lockKey = buildLockKey(zooLock, method, args);//构造分布式锁的键
