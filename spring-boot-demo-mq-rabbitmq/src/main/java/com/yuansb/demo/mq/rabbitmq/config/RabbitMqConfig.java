package com.yuansb.demo.mq.rabbitmq.config;
...
public class RabbitMqConfig {
    ...
    public Queue directOneQueue() {
        return new Queue(RabbitMqConsts.DIRECT_MODE_QUEUE_ONE);
    }
    ...
    public Queue queueTwo() {
        return new Queue(RabbitMqConsts.QUEUE_TWO);
    }
    ...
    public Queue queueThree() {
        return new Queue(RabbitMqConsts.QUEUE_THREE);
    }
    ...
    public FanoutExchange fanoutExchange() {
        return new FanoutExchange(RabbitMqConsts.FANOUT_MODE_QUEUE);
    }
    ...
    public TopicExchange topicExchange() {
        return new TopicExchange(RabbitMqConsts.TOPIC_MODE_QUEUE);
    }
    ...
    public Binding topicBinding1(FanoutExchange fanoutExchange, TopicExchange topicExchange) {
        return BindingBuilder.bind(fanoutExchange).to(topicExchange).with(RabbitMqConsts.TOPIC_ROUTING_KEY_ONE);
    }
    ...
    public Binding topicBinding2(Queue queueTwo, TopicExchange topicExchange) {
        return BindingBuilder.bind(queueTwo).to(topicExchange).with(RabbitMqConsts.TOPIC_ROUTING_KEY_TWO);
    }
    ...
    public Binding topicBinding3(Queue queueThree, TopicExchange topicExchange) {
        return BindingBuilder.bind(queueThree).to(topicExchange).with(RabbitMqConsts.TOPIC_ROUTING_KEY_THREE);
    }
    ...
    public Queue delayQueue() {
        return new Queue(RabbitMqConsts.DELAY_QUEUE, true);
    }
    ...
    public CustomExchange delayExchange() {
        ...
        return new CustomExchange(RabbitMqConsts.DELAY_MODE_QUEUE, "x-delayed-message", true, false, args);
    }
    ...
    public Binding delayBinding(Queue delayQueue, CustomExchange delayExchange) {
        return BindingBuilder.bind(delayQueue).to(delayExchange).with(RabbitMqConsts.DELAY_QUEUE).noargs();
    }
